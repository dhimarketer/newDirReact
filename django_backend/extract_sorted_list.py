#!/usr/bin/env python3
# 2025-01-31: Extract feminine name parts as sorted list from text file

def extract_sorted_feminine_parts():
    """Extract feminine name parts from text file and output as sorted list"""
    ...
    print("SORTED FEMININE NAME PARTS LIST")
    print("=" * 50)
    print(f"Total: {len(feminine_parts_sorted)} feminine name parts")
    print("=" * 50)
    
    for i, part in enumerate(feminine_parts_sorted, 1):
        print(f"{i:4d}. {part}")
