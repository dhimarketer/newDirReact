#!/usr/bin/env python3
"""
2025-01-29: NEW - Clean merge executor with only essential imports
Avoids problematic table references and focuses on core merge functionality
"""
...
# Only import the essential models we need
...
def execute_merge_clean(candidates, batch_size=100):
...
def main():
    ...
    try:
        print("🚀 CLEAN MERGE EXECUTOR - High Confidence (>= 90)")
        print("=" * 60)
        ...
        merge_results = execute_merge_clean(candidates, batch_size=100)
